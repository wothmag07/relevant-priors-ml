...
Both figures are regenerated by `python -m eval.plot_metrics` (re-runs CV and
overwrites `docs/confusion.png` and `docs/roc_pr.png`).
...
python -m eval.run_eval                          # scores the classifier (~5 s)
...
python -m eval.plot_metrics                      # regenerate docs/confusion.png + docs/roc_pr.png
